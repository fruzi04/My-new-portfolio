...
function calculator() {
  ...
  function calcTotal() {
    if (!sex || !height || !weight || !age || !ratio) {
      result.textContent = 'Bведите все данные!';
      return;
    }
    if (sex === 'female') {
  ...
  function getDynamicInformation(selector) {
    ...
    input.addEventListener('input', () => {
      if (input.value.match(/\D/g)) {
        input.style.cssText = "border: 1px solid red; box-shadow: 0px 4px 15px red;";
      } else {
...
function forms(formSelector, modalTimerId) {
  ...
  function showThanksModal(message) {
    ...
    setTimeout(() => {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_0__.closeModalWinow)('.modal');
    }, 4000);
  }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   closeModalWinow: () => (/* binding */ closeModalWinow),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
...
window.addEventListener('DOMContentLoaded', () => {
  const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModalWindow)('.modal', modalTimerId), 50000);
